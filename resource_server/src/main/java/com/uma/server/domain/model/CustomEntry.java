...
public abstract class CustomEntry extends Entry implements Serializable,
	...
	public abstract void setCustomAttributes(
	...
	public String[] getAttributes(String attributeName) {
		...
		for (GluuCustomAttribute attribute : getCustomAttributes()) {
			if (StringHelper.equalsIgnoreCase(attribute.getName(),
					attributeName)) {
	...
	public String toString() {
		return String
				.format("CustomEntry [customAttributes=%s, customObjectClasses=%s, toString()=%s]",
						getCustomAttributes(),
