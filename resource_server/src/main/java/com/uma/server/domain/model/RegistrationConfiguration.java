...
class RegistrationConfiguration {
	...
	public void setAccountsExpirationServiceFrequency(
			String accountsExpirationServiceFrequency) {
	...
	public void setInboundSAMLRegistrationAllowed(
			boolean inboundSAMLRegistrationAllowed) {
	...
	public void setInvitationCodesManagementEnabled(
			boolean invitationCodesManagementEnabled) {
	...
	public void setRegistrationInterceptorsConfigured(
			boolean registrationInterceptorsConfigured) {
	...
	public void setRegistrationInterceptorScripts(
			List<RegistrationInterceptorScript> registrationInterceptorScripts) {
	...
	public void setUninvitedRegistrationAllowed(
			boolean uninvitedRegistrationAllowed) {
